...
function Dragger(props) {
    return _react2["default"].createElement(Uploadimg, (0, _extends3["default"])({}, props, { type: 'drag', style: { height: props.height } }));
}
...
var Uploadimg = function (_React$Component) {
    ...
    Uploadimg.prototype.autoUpdateProgress = function autoUpdateProgress(_, file) {
        var _this2 = this;
    ...
    Uploadimg.prototype.removeFile = function removeFile(file) {
    ...
    Uploadimg.prototype.handleRemove = function handleRemove(file) {
    ...
    Uploadimg.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    Uploadimg.prototype.clearProgressTimer = function clearProgressTimer() {
        clearInterval(this.progressTimer);
    };

    Uploadimg.prototype.render = function render() {
        var _classNames2;
